    ...
    return (
        <>
            <LoadScript googleMapsApiKey="AIzaSyApYvTkH-7FbW4paDE7mUXqNxT56srw6ec">
                <Nav />
                <div className="z-20 w-full bg-slate-50 p-8 pt-24 bg-gradient-radial from-sky-100/90 to-white">
                    <div className="mb-8">
                    ...
                    <div className="w-full flex flex-col md:flex-row z-50 p-4">
                    ...
                    <div
                        className="flex flex-col md:flex-row p-8 z-20"
                    ...
                    >
                        ...
                        <div className="rounded-lg bg-white border p-4 md:ml-4 mt-4 md:mt-0 border-gray-200 shadow-md md:flex-row md:max-w-xl hover:bg-gray-100">
                            <h2 className="text-xl font-bold text-neutral-900">Recomendaciones</h2>
