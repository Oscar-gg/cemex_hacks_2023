  ...
  return (
    <>
        ...
        <div className="z-20 w-full bg-slate-50 p-8 pt-24 bg-gradient-radial from-sky-100/90 to-white">
            <div className="w-full flex z-50 p-4">
        ...
        >
          ...
          <div className="rounded-lg bg-white border p-4 ml-4 border-gray-200 shadow-md md:flex-row md:max-w-xl hover:bg-gray-100">
